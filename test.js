...
*/
function calFee(intelCenterLvl = 0, hideoutmanagement = 0,count = 1, item,fleaPrice){
    let baseFee;
...
console.log(calFee(0,50,13,{BaseValue:16200},30000));

let obj = {lowestFee:99999999999,lowestValue:0,bestFee:0,bestValue:0, bestDif:0};
for(let i = 1; i < 10000000; i++){
    let fee = calFee(3,34,1,{BaseValue:16200},i);
    if(obj.lowestFee >= fee){
        obj.lowestFee = fee;
        obj.lowestValue = i;
    }
    let dif = i - fee;
